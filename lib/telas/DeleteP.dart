          ...
          child:Column(
            ...
            children: <Widget>[
              Form(
                ...
                child: Column(
                  children: <Widget>[
                    Text("Digitar apenas um é suficiente",style: TextStyle(color:Colors.black,backgroundColor: Colors.greenAccent),),
                    Inputtoform("cpf", TextInputType.number,ccpf,'d'),
                    SizedBox(height: 12),
                    Inputtoform("carteira do sus",TextInputType.number,csus,'d'),
                    SizedBox(height:12),
                    ],
                )
              ),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                child: Text("deletar",style: TextStyle(color:Colors.black,fontSize:20),),
